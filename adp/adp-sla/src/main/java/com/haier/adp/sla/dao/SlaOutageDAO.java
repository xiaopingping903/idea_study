...
public class  SlaOutageDAO extends MyBatisDao<SlaOutageDTO>{
    ...
    public  Object getTotalCutPayment(Map map){
    ...
    public List<SlaSupplierDTO> getSupplierByScode(Map map){
        return  this.getSqlSession().selectList("com.haier.adp.sla.dao.SlaOutageDAO.getSupplierByScode", map);
    }
    public List<SlaOutageDTO> getSupplierTimeByScode(Map map){
        return  this.getSqlSession().selectList("com.haier.adp.sla.dao.SlaOutageDAO.getSupplierTimeByScode", map);
    }
    public double getScutPayment(Map map) {
        return  this.getSqlSession().selectOne("com.haier.adp.sla.dao.SlaOutageDAO.getScutPayment", map);
    }
    public List<SlaOutageDTO> getServiceNum(Map map){
        return this.getSqlSession().selectList("com.haier.adp.sla.dao.SlaOutageDAO.getServiceNum",map);
    }
    public int getNotSetSupplierOutageNum(Map map){
        return this.getSqlSession().selectOne("com.haier.adp.sla.dao.SlaOutageDAO.getNotSetSupplierOutageNum",map);
    }
}
